  ...
  describe '編集のテスト' do
      ...
      context '表示の確認と編集' do
        ...
        it '名前編集フォームに自分のカナ姓が表示される' do
          expect(page).to have_field 'フリガナ(セイ)', with: user.last_name_kana
        end
        it '名前編集フォームに自分のカナ名が表示される' do
          expect(page).to have_field 'フリガナ(メイ)', with: user.first_name_kana
        end
        ...
        it '自己紹介編集フォームに自分の自己紹介文が表示される' do
          expect(page).to have_field '自己紹介', with: user.body
        end
        it '編集に成功する' do
          # 名前を三郎に変更
